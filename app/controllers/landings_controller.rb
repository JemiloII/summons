class LandingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @landing.save
        format.html { redirect_to @landing, notice: 'Email was successfully Added.' }
  ...
  def update
    respond_to do |format|
      if @landing.update(landing_params)
        format.html { redirect_to @landing, notice: 'Email was successfully updated.' }
